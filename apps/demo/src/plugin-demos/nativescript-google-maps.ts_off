...
export function onMapReady(args) {
    ...
    mapView.infoWindowTemplate = `<StackLayout orientation="vertical" width="200" >
    ...
    marker = new Marker();
    marker.position = Position.positionFromLatLng(-34.86, 151.20);
    marker.title = "INFOWINDO 2";
    marker.snippet = "Australia";
    marker.color = "green";
    marker.userData = {index: 1};
    mapView.infoWindowTemplate = `<StackLayout orientation="vertical" width="200" >
    ...
    marker = new Marker();
    marker.position = Position.positionFromLatLng(-34.6, 151.20);
    marker.title = "INFOWINDO 3";
    marker.snippet = "Australia";
    marker.color = "green";
    marker.userData = {index: 1};
    mapView.infoWindowTemplate = `<StackLayout orientation="vertical" width="200" >
