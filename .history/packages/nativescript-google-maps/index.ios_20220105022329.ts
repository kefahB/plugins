...
export abstract class GoogleMaps extends GoogleMapsCommon {
    ...
    constructor() {
        ...
        locationManager.delegate = CLLocationManagerDelegateImpl.initWithOwner(new WeakRef(locationManager));
        console.log(locationManager.locationServicesEnabled)
        console.log(locationManager.showsBackgroundLocationIndicator = true)
        locationManager.requestWhenInUseAuthorization();
        console.log(locationManager.authorizationStatus)
        console.log(locationManager.startUpdatingLocation())
