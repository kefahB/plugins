...
export abstract class GoogleMaps extends GoogleMapsCommon {
    ...
    public createNativeView() {
        ...
        //android.content.pm.PackageInfo.getPackageInfo(com.google.android.gms.common.GoogleApiAvailability.GOOGLE_PLAY_SERVICES_PACKAGE, 0 ));
        console.log(android.content.pm.PackageInfo.getPackageInfo(com.google.android.gms.common.GoogleApiAvailability.GOOGLE_PLAY_SERVICES_PACKAGE, 0 ))
            ...
            onMapReady: (gMap) => {
                ...
                gMap.setOnMarkerClickListener(new com.google.android.gms.maps.GoogleMap.OnMarkerClickListener({
                    onMarkerClick: (gmsMarker) => {
                        ...
                        console.log("setOnMarkerClickListener")
