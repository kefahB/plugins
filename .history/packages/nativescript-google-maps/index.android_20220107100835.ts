...
export abstract class GoogleMaps extends GoogleMapsCommon {
    ...
    onLoaded() {
        super.onLoaded();
        const mapsInitializer = com.google.android.gms.maps.MapsInitializer.initialize(Application.android.context)
    ...
    public createNativeView() {
        ...
        const mapsInitializer = com.google.android.gms.maps.MapsInitializer;
        const OnMapsSdkInitializedCallback =  com.google.android.gms.maps.OnMapsSdkInitializedCallback;

        //mapsInitializer.initialize(this._context, mapRenderer.LATEST, this);
        ClickListener.onMapsSdkInitialized(mapRenderer)
