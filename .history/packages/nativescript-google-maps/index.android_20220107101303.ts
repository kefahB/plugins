...
export abstract class GoogleMaps extends GoogleMapsCommon {
    ...
    public createNativeView() {
        ...
        const mapsInitializer = com.google.android.gms.maps.MapsInitializer.initialize(this._context)
        console.log(mapsInitializer)
        console.log(this._context)
        console.log(Application.android.context)
        com.google.android.gms.maps.MapsInitializer.initialize(this._context, com.google.android.gms.maps.MapsInitializer.Renderer.LATEST, this);
