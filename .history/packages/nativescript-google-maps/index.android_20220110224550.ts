            ...
            onMapReady: (gMap) => {
                ...
                gMap.setOnInfoWindowClickListener(new com.google.android.gms.maps.GoogleMap.OnInfoWindowClickListener({
                    onInfoWindowClick: (gmsMarker) => {
                        console.log("setOnInfoWindowClickListener", gmsMarker)
...
export class Marker extends MarkerBase {
    ...
    /**
     * https://developers.google.com/maps/documentation/android-sdk/infowindows#:~:text=Remarque%20sur%20l%27actualisation%20d%27une%20fen%C3%AAtre%20d%27informations
     * According to the docs, if we set programmaticly 
     */
    showInfoWindow(): void {
        if (this._isMarker) {
            console.log("this._isMarker", this._isMarker)
            console.log("this.isInfoWindowShown()", this._android.showInfoWindow())
