...
class MapViewDelegateImpl extends NSObject implements GMSMapViewDelegate {
    ...
    public didTapMyLocationButtonForMapView(mapView: GMSMapView): boolean {
        ...
        if (owner) {
            ...
            console.log(mapView.projection.coordinateForPoint(mapView.center).latitude)
            console.log(mapView.projection.coordinateForPoint(mapView.center).longitude)
            mapView.projection.coordinateForPoint(mapView.center).latitude
            mapView.projection.coordinateForPoint(mapView.center).longitude
