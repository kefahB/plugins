...
const mapRenderer =  com.google.android.gms.maps.MapsInitializer.Renderer;
@NativeClass
class OnMapsSdkInitializedCallback extends java.lang.Object {
    constructor() {
        super();
    ...
    onMapsSdkInitialized(renderer): void {
        console.log(" /. /. /. /./ . /. /.")
        console.log(" /. /. /. /./ . /. /.")
        console.log(renderer)
        switch (renderer) {
            case mapRenderer.LATEST:
              console.log("MapsDemo", "The latest version of the renderer is used.");
              break;
            case mapRenderer.LEGACY:
              console.log("MapsDemo", "The legacy version of the renderer is used.");
              break;
          }
    }
}
let ClickListener = new OnMapsSdkInitializedCallback();
...
export abstract class GoogleMaps extends GoogleMapsCommon {
    ...
    public createNativeView() {
        ...
        //const mapsInitializer = com.google.android.gms.maps.MapsInitializer.initialize(this._context, null, new com.google.android.gms.maps.OnMapsSdkInitializedCallback(com.google.android.gms.maps.MapsInitializer.LATEST))
        const mapsInitializer = com.google.android.gms.maps.MapsInitializer.initialize(this._context, com.google.android.gms.maps.MapsInitializer.Renderer.LATEST, new com.google.android.gms.maps.OnMapsSdkInitializedCallback({
            onMapsSdkInitialized: (renderer) => {
                console.log(renderer)
            }
        }))
        console.log(mapsInitializer)
        ...
        var mapReadyCallback = new com.google.android.gms.maps.OnMapReadyCallback({
            onMapReady: (gMap) => {
                ...
                let cameraChangeHandler = (cameraPosition) => {
                    ...
                    if (cameraChanged) {
                        owner.notifyCameraEvent(GoogleMaps.cameraChangedEvent, {
