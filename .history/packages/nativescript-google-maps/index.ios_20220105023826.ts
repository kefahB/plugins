...
class CLLocationManagerDelegateImpl extends NSObject implements CLLocationManagerDelegate {
    ...
    public _owner: WeakRef<GoogleMaps>;

    public static initWithOwner(owner: WeakRef<GoogleMaps>): CLLocationManagerDelegateImpl {
...
export abstract class GoogleMaps extends GoogleMapsCommon {
    ...
    constructor() {
        ...
        this.locationManager.delegate = CLLocationManagerDelegateImpl.initWithOwner(new WeakRef(this));
