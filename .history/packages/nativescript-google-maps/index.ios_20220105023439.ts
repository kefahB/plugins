...
class MapViewDelegateImpl extends NSObject implements GMSMapViewDelegate {
    ...
    public didTapMyLocationButtonForMapView(mapView: GMSMapView): boolean {
        const owner = this._owner.get();
        if (owner) {
            console.log("didTapMyLocationButtonForMapView")
            owner.bearing = 33;
...
class CLLocationManagerDelegateImpl extends NSObject implements CLLocationManagerDelegate {
    public static ObjeCProtocols = [CLLocationManagerDelegate];

    public _owner: WeakRef<CLLocationManager>;

    public static initWithOwner(owner: WeakRef<CLLocationManager>): CLLocationManagerDelegateImpl {
...
export abstract class GoogleMaps extends GoogleMapsCommon {
    ...
    private _cLLocationManagerDelegateImpl:CLLocationManagerDelegateImpl;
    ...
    constructor() {
        ...
        this.locationManager.delegate = CLLocationManagerDelegateImpl.initWithOwner(new WeakRef(this.locationManager));
    ...
    private _createCameraPosition() {
        ...
        console.log(this.locationManager.desiredAccuracy = kCLLocationAccuracyBest)
        console.log(this.locationManager.locationServicesEnabled)
        console.log(this.locationManager.showsBackgroundLocationIndicator = true)
        this.locationManager.requestWhenInUseAuthorization();
        console.log(this.locationManager.authorizationStatus)
        console.log(this.locationManager.startUpdatingLocation())
        console.log(this.locationManager.showsBackgroundLocationIndicator = true)
