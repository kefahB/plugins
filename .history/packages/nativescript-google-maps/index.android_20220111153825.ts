...
export abstract class GoogleMaps extends GoogleMapsCommon {
    ...
    public createNativeView() {
        ...
        let v = androidx.core.content.pm.PackageInfoCompat.getLongVersionCode(android.content.pm.PackageManager.getPackageManager().getPackageInfo(com.google.android.gms.common.GoogleApiAvailability.GOOGLE_PLAY_SERVICES_PACKAGE, 0 ));
        console.log(v)
