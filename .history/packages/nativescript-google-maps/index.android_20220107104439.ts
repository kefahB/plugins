...
export abstract class GoogleMaps extends GoogleMapsCommon {
    ...
    public createNativeView() {
        ...
        const mapsInitializer = com.google.android.gms.maps.MapsInitializer.initialize(this._context, LATEST, new com.google.android.gms.maps.OnMapsSdkInitializedCallback({
