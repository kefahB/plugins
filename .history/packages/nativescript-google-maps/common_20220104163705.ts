...
function onInfoWindowTemplatesChanged(mapView: NativescriptGoogleMapsCommon) {
...
function onMapPropertyChanged(mapView: NativescriptGoogleMapsCommon) {
    if (!mapView.processingCameraEvent) mapView.updateCamera();
}

function onSetMinZoomMaxZoom(mapView: NativescriptGoogleMapsCommon) {
    mapView.setMinZoomMaxZoom();
}

function onPaddingPropertyChanged(mapView: NativescriptGoogleMapsCommon) {
...
export abstract class NativescriptGoogleMapsCommon extends View {
    ...
    notifyMapReady() {
        this.notify({ eventName: NativescriptGoogleMapsCommon.mapReadyEvent, object: this, gMap: this.gMap });
    }
    ...
    notifyMarkerTapped(marker: MarkerBase) {
        this.notifyMarkerEvent(NativescriptGoogleMapsCommon.markerSelectEvent, marker);
    }

    notifyMarkerInfoWindowTapped(marker: MarkerBase) {
        this.notifyMarkerEvent(NativescriptGoogleMapsCommon.markerInfoWindowTappedEvent, marker);
    }

    notifyMarkerInfoWindowClosed(marker: MarkerBase) {
        this.notifyMarkerEvent(NativescriptGoogleMapsCommon.markerInfoWindowClosedEvent, marker);
    }

    notifyShapeTapped(shape: ShapeBase) {
        this.notifyShapeEvent(NativescriptGoogleMapsCommon.shapeSelectEvent, shape);
    }

    notifyMarkerBeginDragging(marker: MarkerBase) {
        this.notifyMarkerEvent(NativescriptGoogleMapsCommon.markerBeginDraggingEvent, marker);
    }

    notifyMarkerEndDragging(marker: MarkerBase) {
        this.notifyMarkerEvent(NativescriptGoogleMapsCommon.markerEndDraggingEvent, marker);
    }

    notifyMarkerDrag(marker: MarkerBase) {
        this.notifyMarkerEvent(NativescriptGoogleMapsCommon.markerDragEvent, marker);
    }
    ...
    notifyMyLocationTapped() {
        this.notify({ eventName: NativescriptGoogleMapsCommon.myLocationTappedEvent, object: this });
    }

    notifyBuildingFocusedEvent(indoorBuilding: IndoorBuilding) {
        let args: BuildingFocusedEventData = { eventName: NativescriptGoogleMapsCommon.indoorBuildingFocusedEvent, object: this, indoorBuilding: indoorBuilding };
        this.notify(args);
    }

    notifyIndoorLevelActivatedEvent(activateLevel: IndoorLevel) {
        let args: IndoorLevelActivatedEventData = { eventName: NativescriptGoogleMapsCommon.indoorLevelActivatedEvent, object: this, activateLevel: activateLevel };
        this.notify(args);
    }
}


export const infoWindowTemplateProperty = new Property<NativescriptGoogleMapsCommon, string | Template>({ name: "infoWindowTemplate" });
infoWindowTemplateProperty.register(NativescriptGoogleMapsCommon);

export const infoWindowTemplatesProperty = new Property<NativescriptGoogleMapsCommon, string | Array<KeyedTemplate>>({ name: "infoWindowTemplates", valueChanged: onInfoWindowTemplatesChanged })
infoWindowTemplatesProperty.register(NativescriptGoogleMapsCommon);

export const latitudeProperty = new Property<NativescriptGoogleMapsCommon, number>({ name: 'latitude', defaultValue: 0, valueChanged: onMapPropertyChanged });
latitudeProperty.register(NativescriptGoogleMapsCommon);

export const longitudeProperty = new Property<NativescriptGoogleMapsCommon, number>({ name: 'longitude', defaultValue: 0, valueChanged: onMapPropertyChanged });
longitudeProperty.register(NativescriptGoogleMapsCommon);

export const bearingProperty = new Property<NativescriptGoogleMapsCommon, number>({ name: 'bearing', defaultValue: 0, valueChanged: onMapPropertyChanged });
bearingProperty.register(NativescriptGoogleMapsCommon);

export const zoomProperty = new Property<NativescriptGoogleMapsCommon, number>({ name: 'zoom', defaultValue: 0, valueChanged: onMapPropertyChanged });
zoomProperty.register(NativescriptGoogleMapsCommon);

export const minZoomProperty = new Property<NativescriptGoogleMapsCommon, number>({ name: 'minZoom', defaultValue: 0, valueChanged: onSetMinZoomMaxZoom });
minZoomProperty.register(NativescriptGoogleMapsCommon);

export const maxZoomProperty = new Property<NativescriptGoogleMapsCommon, number>({ name: 'maxZoom', defaultValue: 22, valueChanged: onSetMinZoomMaxZoom });
maxZoomProperty.register(NativescriptGoogleMapsCommon);

export const tiltProperty = new Property<NativescriptGoogleMapsCommon, number>({ name: 'tilt', defaultValue: 0, valueChanged: onMapPropertyChanged });
tiltProperty.register(NativescriptGoogleMapsCommon);

export const paddingProperty = new Property<NativescriptGoogleMapsCommon, number[]>({ name: 'padding', valueChanged: onPaddingPropertyChanged, valueConverter: paddingValueConverter });
paddingProperty.register(NativescriptGoogleMapsCommon);

export const mapAnimationsEnabledProperty = new Property<NativescriptGoogleMapsCommon, boolean>({ name: 'mapAnimationsEnabled', defaultValue: true });
mapAnimationsEnabledProperty.register(NativescriptGoogleMapsCommon);
